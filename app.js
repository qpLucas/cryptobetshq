...
var TRANSLATIONS = {
  ...
  cs: {
    ...
    footer_rights:'V\u0161echna pr\u00e1va vyhrazena',footer_age:'18+',footer_gamble:'Hrajte zodpov\u011bdn\u011b',
    bc_home:'Dom\u016f',
    art_cta_title:'P\u0159ipraveni hr\u00e1t?',art_cta_desc:'Z\u00edskejte bonus a\u017e 5 BTC.',
    art_cta_btn:'P\u0159idat se na Cloudbet \u2197',no_articles:'Zat\u00edm \u017e\u00e1dn\u00e9 \u010dl\u00e1nky.',
  },
};
...
(function() {
  ...
  DB.set('articles', [
    { id:1,  cat:'casino',     lang:'en', title:'Sweet Bonanza Xmas \u2014 High Volatility, Max Win \xd721,100', summary:'Pragmatic Play\'s scatter-pays mechanic rewards patience. We break down why this slot dominates crypto casinos.', img:'https://images.unsplash.com/photo-1596838132731-3301c3fd4317?w=600&q=80', date:'2 Jun 2026', createdAt:new Date().toISOString() },
...
function getHeaderHTML(active) {
  var nav = [
    ...
    { label:t('nav_rewards'),    href:'/rewards', bonus:true },
  ...
  return '<header class="site-header">'
    ...
    + '<span class="tl-we">WeWin</span><span class="tl-crypto">Crypto</span>'
    + '</a>'
    ...
    + '<span class="tl-we" style="font-size:20px">WeWin</span><span class="tl-crypto" style="font-size:20px">Crypto</span>'
    ...
    + '<a href="/rewards" class="mob-bonus">' + t('nav_rewards') + '</a>'
...
function getFooterHTML() {
  ...
  return '<footer class="site-footer">'
    ...
    + ' &middot; &copy; ' + new Date().getFullYear() + ' ' + t('footer_rights')
